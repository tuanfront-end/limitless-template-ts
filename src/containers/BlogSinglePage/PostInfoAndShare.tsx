...
export default function PostInfoAndShare({
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center bg-gray-800 dark:bg-gray-900 w-14 h-14">
      ...
      <button className="flex flex-col items-center justify-center bg-transparent w-14 p-2px">
        <span className="uppercase text-paragraph-tiny text-gray-800 dark:text-red-200 font-bold">
          Save
        </span>
