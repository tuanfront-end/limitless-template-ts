  ...
  return (
    <div>
      ...
      <div className="mt-6 flex flex-col items-start">
        <span className="text-small-caps font-bold text-neutral-200 dark:text-neutral-800 mb-1">
          Blog
        </span>
        <h2 className="text-f5 text-black dark:text-white font-bold mb-3 capitalize">
          <a href="//#endregion">{title}</a>
        </h2>
        <span className="text-paragraph-small text-neutral-200 dark:text-neutral-800 mb-6">
