...
const SectionTeam = () => {
  return (
    <div className="container ttnc-SectionTeam py-20 lg:flex items-center">
      <div className="lg:w-5/12 mb-10 lg:mb-0 md:pr-14 text-black dark:text-white">
        <h1 className="text-f1 font-bold mb-4">
          Our <span className="ttnc-title-underline">Team</span>
        </h1>
        <span className="block mb-4 text-paragraph-base">
        ...
        <Button size="small">All Team Member</Button>
      </div>
